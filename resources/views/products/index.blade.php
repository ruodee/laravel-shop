            ...
            <div class="card-body">
                ...
                <form action="{{ route('products.index') }}" class="search-form">
                    <div class="form-row">
                        <div class="col-md-9">
                            <div class="form-row">
                                ...
                                <div class="col-auto category-breadcrumb">
                                    ...
                                    <!-- 如果当前是通过类目筛选的 -->
                                    @if($category)
                                    <!-- 遍历这个类目的所有祖先类目，我们在模型的访问器中已经排序好，因此可以直接使用 -->
                                ...
                                @foreach($propertyFilters as $name => $value)
                                    <span class="filter">{{ $name }}:
                                        ...
                                        <a href="javascript: removeFilterFromQuery('{{ $name }}')" class="remove-filter">×</a>
                                    </span>
                                @endforeach
                                <!-- 商品属性面包屑结束 -->
                                </div>
                        ...
                        <div class="col-md-3"><select name="order" class="form-control form-control-sm float-right">
                        ...
                        <div class="col-3 product-item">
                            <div class="product-content">
                                ...
                                <div class="bottom">
                                    ...
                                    <div class="sold_count">评价<span>{{ $product->review_count }}</span></div>
                                </div>
                            </div>
                        </div>
                    @endforeach
