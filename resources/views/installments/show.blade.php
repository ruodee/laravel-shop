                    ...
                    <div class="installment-top">
                        <div class="installment-info">
                            <div class="line">
                                ...
                                <div class="line-value"><a href="{{ route('orders.show', ['order' => $installment->order->id]) }}" target="_blank">查看</a></div>
                            </div>
                            <div class="line">
                                <div class="line-label">分期金额：</div>
                                <div class="lien-value">￥{{ $installment->total_amount }}</div>
                            </div>
                            <div class="line">
