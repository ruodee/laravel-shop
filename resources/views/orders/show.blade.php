                    ...
                    @foreach($order->items as $index => $item)
                        <tr>
                            <td class="product-info">
                                <div class="preview">
                                    <a href="{{ route('products.show', [$item->product_id]) }}" target="_blank"><img src="{{ $item->product->image_url }}" alt=""></a>
                                </div>
                                <div>
                    ...
                    <div class="order-summary text-right">
                       ...
                       @if($order->ship_status === \App\Models\Order::SHIP_STATUS_DELIVERED)
                        <div class="receive-button">
                            <!-- 改用 axios ajax确认收货 -->
                            <button id="btn-receive" class="btn btn-sm btn-success" type="button">确认收货</button>
                        </div>
                       @endif
