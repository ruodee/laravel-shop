                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" role="form" action="{{ route('user_addresses.store') }}" method="post">
                      @endif
                       ...
                       {{-- 插入了3个隐藏字段 --}}
                       {{-- 通过 v-modle 与 user-addresses-create-and-edit 组件里的值关联起来 --}}
                       {{-- 当组件中的值变化时，这里的值也会跟这变 --}}
                       ...
                       <div class="form-group row">
                           ...
                           <div class="col-sm-9"><input type="text" class="form-control" name="zip" value="{{ old('zip', $address->zip) }}"></div>
                       </div>
                       <div class="form-group row">
                       ...
                       <div class="form-group row">
                           ...
                           <div class="col-sm-9"><input type="text" class="form-control" name="contact_phone" value="{{ old('contact_phone', $address->contact_phone) }}"></div>
                       </div>
